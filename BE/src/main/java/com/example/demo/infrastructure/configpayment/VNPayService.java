...
public class VNPayService {
    ...
    public String createOrder(CustomerVNPayRequest vnPayRequest, String urlReturn) {
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String vnp_TxnRef = VNPayConfig.getRandomNumber(8);
        String vnp_IpAddr = "192.168.0.106";
        ...
        vnp_Params.put("vnp_OrderInfo", vnPayRequest.getBookingInfor());
