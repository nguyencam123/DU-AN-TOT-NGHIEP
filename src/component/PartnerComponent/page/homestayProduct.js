...
const HomeStayProduct = () => {
  ...
  const handleDateChangestart = (dates) => {
    setstartDate(moment(dates));
  };
  const [endDate, setendDate] = useState(null)
  const handleDateChangeend = (dates) => {
    setendDate(moment(dates));
  };
          ...
          <Row gutter={24}>
            ...
            <Col span={12}>
              <Form.Item
                ...
                name="startDate"
                >
                  <DatePicker value={startDate} onChange={handleDateChangestart} />
                </Form.Item>
              </Col>
            </Row>
            <Row gutter={24}>
              <Col span={12}>
                <Form.Item
                  ...
                  name="endDate"
                >
                  <DatePicker value={endDate} onChange={handleDateChangeend} />
                </Form.Item>
              </Col>
            </Row>
          </Form>
