...
const ResetPassWordOwner = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`http://localhost:8080/api/v2/login/reset-password?username=${userName}`);
        ...
        <section style={{ display: 'flex', justifyContent: 'center', marginTop: 100, marginBottom: 100 }}>
            <div style={{ border: '1px solid #b2b2b2', width: 500, height: '100%', borderRadius: 5, padding: 15 }}>
                ...
                <div style={{ fontWeight: '500', color: '#363535', fontSize: 16 }}>
                    Nhập tài khoản đã đăng ký của bạn để đặt lại mật khẩu</div><br />
                <div style={{ fontWeight: '500', color: '#363535', fontSize: 16 }}>
                    Tài khoản</div>
                <MDBInput
                    wrapperClass='mb-4'
