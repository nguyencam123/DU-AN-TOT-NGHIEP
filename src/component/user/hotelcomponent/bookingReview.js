        ...
        >
          <Row>
            <Col span={24}>
              ...
              >
                Vui lòng xem lại chi tiết đặt phòng của bạn trước khi tiếp tục
                đến bước thanh toán
              </div>
            </Col>
          </Row>
          <Row style={{ marginTop: '25px' }}>
            <Col span={17}>
              <h5 style={{ fontWeight: '700' }}>Homestay</h5>
            ...
            <Col span={6} push={1} style={{ marginTop: '8px' }}>
              <div style={{ backgroundColor: 'white', borderRadius: '10px' }}>
                ...
                <Col
                  span={22}
                  push={1}
                  style={{ marginTop: '5px', paddingBottom: '10px' }}
                >
                  <div
                    style={{
                      fontSize: '16px',
                ...
                <Col span={18}>
                  <div style={{ marginLeft: '10px', marginTop: '10px' }}>
                    ...
                    <span style={{ lineHeight: '12px', marginLeft: '17px' }}>
                      Giờ nhận phòng: <b>Từ 12:00</b>
                    </span>
                    <span style={{ lineHeight: '12px', marginLeft: '17px' }}>
                      Giờ trả phòng: <b>Trước 14:00</b>
                    </span>
                  </div>
                  ...
                  <div style={{ marginLeft: '10px', marginTop: '10px' }}>
                    ...
                    <span style={{ lineHeight: '12px', marginLeft: '17px' }}>
                      Việc hủy phòng trước ngày abcxyz sẽ được hoàn toàn miễn
                      phí. Sau ngày abcxyz bạn sẽ phải mất một khoản tiền khi
                      hủy phòng
                    </span>
                  </div>
                  <hr style={{ width: '96%', marginLeft: '2%' }} />
                  <div style={{ marginLeft: '10px', marginTop: '10px' }}>
                    ...
                    <div style={{ lineHeight: '16px', marginLeft: '17px' }}>
                      Please note that your children might be charged when
                      check-in at the hotel. Please call the hotel before your
                      check-in date for further information. Vui long luu y, tre
                      em co the bi thu them phi khi nhan phong tai khach san.
                      Vui long lien he khach san truoc khi nhan phong de biet
                      them thong tin chi tiet.
                    </div>
                  </div>
                  <hr style={{ width: '96%', marginLeft: '2%' }} />
                  <div style={{ margin: '10px 15px 0px 10px' }}>
                    <div
                      style={{ lineHeight: '12px', margin: '0px 0px 15px 5px' }}
                    >
                      <b> Thông tin chung</b>
                    </div>
              ...
              <div style={{ backgroundColor: 'white', borderRadius: '10px' }}>
                ...
                <Row style={{ marginTop: '15px' }}>
                  ...
                  <Col span={20} push={1}>
                    ...
                    >
                      Thuế và phí là các khoản được TravelVIVU chuyển trả cho
                      khách sạn. Mọi thắc mắc về thuế và hóa đơn, vui lòng tham
                      khảo Điều khoản và Điều kiện của TravelVIVU để được giải
                      đáp
                    </div>
                    <hr />
                  </Col>
