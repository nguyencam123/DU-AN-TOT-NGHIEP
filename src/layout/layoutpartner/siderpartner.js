...
const items = [
  ...
  { label: 'Quản lý đặt phòng', key: '2', icon: <DesktopOutlined />, route: 'partner/booking', component: <HomeStayProduct /> },
  { label: 'Quản lý thống kê', key: '3', icon: <DesktopOutlined />, route: 'partner/categor', component: <HomeStayProduct /> },
